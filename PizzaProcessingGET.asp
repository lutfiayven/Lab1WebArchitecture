...
<body>
    <div class="container">
        <div class="row">
             <% 
                queryStringData = request.querystring()
                response.write(queryStringData)

                userName = request.querystring("userName")
                size = request.querystring("sizeRadio")
                toppings = request.querystring("toppingCheckbox")
                toppingsCount = request.querystring("toppingCheckbox").count
